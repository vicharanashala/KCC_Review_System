...
export const ReviewQueue = () => {
  ...
  if (task?.type == "Reject") {
    avilableSourceList = task.sources || [
  ...
  const [reviewerInsights, setReviewerInsights] = useState<ReviewerInsights>({
    approvals: 0,
    revisions: 0,
  });
  ...
  const fetchVersionHistory = async () => {
    ...
    try {
      ...
      history.forEach((versionData, index) => {
        ...
        const answerText =
          versionData.answer_text || "No answer text available";
        ...
        peerValidations.forEach((validation, idx) => {
          ...
          versionItem.reviewers.push({
            reviewer: `${
              validation.reviewer_email || validation.reviewer_name || "Unknown"
            } `,
  ...
  const handleSubmitAnswer = async () => {
    ...
    try {
      ...
      const answerData: AnswerData = {
        ...
        peer_validation_id: task.peer_validation_id
          ? task.peer_validation_id
          : "",
    ...
    try {
      ...
      if (user?.role === "moderator") {
        ...
        validationData = {
          ...
          comments: comments.trim() || undefined,
          revised_answer_text:
            selectedStatus === "revised" ? revisedAnswer.trim() : undefined,
          notification_id: task.notification_id ? task.notification_id : "",
          peer_validation_id: task.peer_validation_id
            ? task.peer_validation_id
            : "",
      ...
      showSuccess(
        responseData.message ||
          `Answer ${
            selectedStatus === "approved" ? "approved" : "revision submitted"
          } successfully!`
      );
  ...
  const VersionHistoryComponent = () => (
    ...
    >
      <Typography
        variant="h6"
        sx={{ fontWeight: 600, mb: 1, color: "#333", fontSize: "15px" }}
      >
        Version History
      </Typography>
      <Typography
        variant="body2"
        sx={{ color: "#717182", mb: 3, fontSize: "14px" }}
      >
    ...
    >
      ...
      <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
        ...
        {rev.comments && (
          ...
          >
            <IconButton size="small" sx={{ p: 0.5, ml: 1 }}>
              <CommentIcon sx={{ fontSize: 16, color: color }} />
            </IconButton>
          </Tooltip>
        )}
      </Box>
      ...
      {!isLoadingVersionHistory && (
        <Box sx={{ mt: 5, mb: 4 }}>
          <Typography
            variant="h6"
            sx={{ fontWeight: 600, mb: 2, color: "#333", fontSize: "16px" }}
          >
            Reviewer Insights
          </Typography>
          <Box sx={{ display: "flex", gap: 2 }}>
            ...
            >
              ...
              <Typography
                variant="body2"
                sx={{ color: "#00C950", fontSize: "12px", fontWeight: 500 }}
              >
                Approvals
              </Typography>
            </Box>
            ...
            >
              ...
              <Typography
                variant="body2"
                sx={{ color: "#F0B100", fontSize: "12px", fontWeight: 500 }}
              >
                Revision
              </Typography>
            </Box>
  ...
  if (error || !task) {
    return (
      <Box sx={{ p: 3, maxWidth: 800, mx: "auto" }}>
        ...
        <Typography color="error">{error || "Question not found"}</Typography>
      </Box>
    );
  }
    ...
    >
      {task?.type === "question_validation" ? (
        <Box>
          ...
          <Box
            sx={{ gap: 3, alignItems: "flex-start", justifyContent: "center" }}
          >
            <Box
              sx={{
                flex: 1,
          ...
          >
              ...
              <TextField
                placeholder={
                  !selectedStatus
                    ...
                    ? "No changes needed for approval"
                    : user?.role === "moderator"
                    ? "Answer text (read-only for moderators)"
                    : "Edit the answer if needed (only for revisions)"
                }
                multiline
                rows={2}
                fullWidth
            ...
            <Box sx={{ my: 2 }}>
              ...
              <TextField
                ...
                sx={{
                  "& .MuiOutlinedInput-root": {
                    bgcolor:
                      selectedStatus === "approved" ? "#f5f5f5" : "#fff8f0",
                    borderRadius: "8px",
                    "& fieldset": {
                      border: "1px solid #f0e0d0",
                    },
                    "&:hover fieldset": {
                      borderColor:
                        selectedStatus === "approved" ? "#f0e0d0" : "#e0c0a0",
                    },
                  },
                }}
              />
            ...
            >
              ...
              <Button
                variant={
                  selectedStatus === "approved" ? "contained" : "outlined"
                }
                ...
                sx={{
                  ...
                  borderColor: "#4caf50",
                  backgroundColor:
                    selectedStatus === "approved" ? "#4caf50" : "transparent",
                  "&:hover": {
                    backgroundColor:
                      selectedStatus === "approved"
                        ? "#388e3c"
                ...
                {task.answer_preview && (
                  ...
                  >
                    ...
                    <Typography
                      ...
                      sx={{
                        lineHeight: 1.6,
                        maxHeight: 150, // set height limit
                      ...
                      <div key={ind}>
                        <Box sx={{ display: "flex", gap: 2, my: 2 }}>
                          <TextField
                            ...
                            onChange={(e) =>
                              handleChange(sourceEle.id, "name", e.target.value)
                            }
                            fullWidth
                            variant="outlined"
                            size="small"
                            error={
                              Boolean(sourceEle?.errorsList?.name) || false
                            }
                          ...
                          <TextField
                            ...
                            size="small"
                            error={
                              Boolean(sourceEle?.errorsList?.link) || false
                            }
                            ...
                            sx={{
                              "& .MuiOutlinedInput-root": {
                                ...
                                "&:hover fieldset": {
                                  borderColor: urlError ? "#d32f2f" : "#e0c0a0",
                                },
                              },
                            }}
                          />
                          ...
                          {sources.length > 1 && (
                            <button onClick={() => removeGroup(sourceEle.id)}>
                              X{" "}
                            </button>
                          )}
                        </Box>
                ...
                >
                  ...
                  >
                    ...
                    <Button
                      ...
                      sx={{
                        color:
                          selectedStatus === "approved" ? "#ffffff" : "#4caf50",
                        borderColor: "#4caf50",
                        backgroundColor:
                          selectedStatus === "approved"
                            ? "#4caf50"
